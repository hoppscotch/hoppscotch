...
// Platform-specific types for selfhost-web
type UserCollection = {
    id: string
    title: string
    data: string | null
 ...
 * This is a platform-specific version for selfhost-web that handles nested collections properly
 */
 ...
 * Platform-specific version for selfhost-web that uses the correct nested queries
 */
