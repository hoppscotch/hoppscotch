    ...
    >
      ...
      <div class="flex">
        ...
        <HoppButtonSecondary
          ...
          :class="{ '!text-accent': WRAP_LINES_HTTP_REQUEST_BODY }"
          :icon="IconWrapText"
          @click.prevent="toggleSetting('WRAP_LINES_HTTP_REQUEST_BODY')"
        />
        <HoppButtonSecondary
          v-if="
            [
...
const WRAP_LINES_HTTP_REQUEST_BODY = useSetting("WRAP_LINES_HTTP_REQUEST_BODY")
...
useCodemirror(
  ...
  reactive({
    extendedEditorConfig: {
      lineWrapping: WRAP_LINES_HTTP_REQUEST_BODY,
