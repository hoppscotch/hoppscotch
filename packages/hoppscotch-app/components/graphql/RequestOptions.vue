...
const copyQueryIcon = refAutoReset("copy", 1000)
const copyVariablesIcon = refAutoReset("copy", 1000)
const prettifyQueryIcon = refAutoReset("wand", 1000)
const prettifyVariablesIcon = refAutoReset("wand", 1000)
