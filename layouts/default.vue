  ...
  <div class="wrapper">
    <header class="header">
      <div>
        <div class="slide-in">
          <nuxt-link to="/">
            <logo class="logo-image" /> <h1 class="logo">Postwoman</h1>
          </nuxt-link>
        ...
        <div>
          <button
            class="icon"
            onClick="window.open('https://twitter.com/share?text=👽 Postwoman • API request builder - Helps you create your requests faster, saving you precious time during development!&url=https://postwoman.io&hashtags=postwoman&via=liyasthomas');">
          ...
          <a href="https://github.com/liyasthomas/postwoman" target="_blank" rel="noopener">
            <button class="icon">
              <github-logo id="imgGitHub" alt="GitHub" :style="logoStyle()" />
              <span>GitHub</span>
            </button>
          </a>
        </div>
      ...
      <div class="columns">
        <aside class="nav-first">
          <nav class="primary-nav">
            ...
            -->
            <nuxt-link to="/" :class="linkActive('/')" v-tooltip.right="'HTTP'" aria-label="HTTP">
          ...
          <div v-else-if="['/websocket'].includes($route.path)">
            <nav class="secondary-nav">
              <ul>
                <li>
                  <a href="#connection" v-tooltip.right="'Connection'">
                    <i class="material-icons">settings_ethernet</i>
                  </a>
                </li>
                <li>
                  <a href="#communication" v-tooltip.right="'Communication'">
